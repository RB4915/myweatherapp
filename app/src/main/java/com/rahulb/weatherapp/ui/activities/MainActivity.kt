...
import com.rahulb.weatherapp.utils.*
import com.rahulb.weatherapp.viewmodel.MyViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var model: com.rahulb.weatherapp.data.repository.local.LocationProvider
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        model = com.rahulb.weatherapp.data.repository.local.LocationProvider(this)
    ...
    private fun setUpUI(data: com.rahulb.weatherapp.data.models.ResponseWeather?) {
