package com.rahulb.weatherapp.ui.adapters
...
import com.rahulb.weatherapp.utils.DiffUtilCallbackForecast
import com.rahulb.weatherapp.utils.unixTimestampToDateTimeString
import com.rahulb.weatherapp.utils.unixTimestampToTimeString
...
class ForecastAdapter():RecyclerView.Adapter<ForecastAdapter.Holder>() {
    ...
    private fun bindData(holder: Holder, data: com.rahulb.weatherapp.data.models.Daily?) {
